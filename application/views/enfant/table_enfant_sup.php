    ...
    <div class="bg-dark dk" id="wrap">
      ...
      <div id="content">
        <div class="outer">
          ...
          <td width="20px" align="center"><li class="col-sm-6 col-md-4 col-lg-3" ><i class="glyphicon glyphicon-trash"></i>&nbsp;<a href="<?php echo site_url('enfant_controller/form_supp/'.$enfant->idEnfant);?>" class="text-danger">Supprimer</a> </li></td>
                        </tr>
                        <?php endforeach; ?>
                        <?php endif; ?>
                      </tbody>
