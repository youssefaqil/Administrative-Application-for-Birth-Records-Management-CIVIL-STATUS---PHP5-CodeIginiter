...
.btn-circle {
  ...
  <div class="bg-dark dk" id="wrap">
    ...
    <div class="stepwizard-row setup-panel">
      ...
      <form role="form" action="<?php echo site_url('enfant_controller/Ajout_enf'); ?>" method="post">
    <div class="row setup-content" id="step-1">
        ...
        <div class="col-md-12">
            ...
            <input maxlength="100" type="text" name="NomE" required="required" class="form-control" placeholder="Enter Last Name" />
          </div>
          <div class="form-group">
            <label class="control-label">PRENOM</label>
            <input maxlength="100" type="text" name="PreNomE" required="required" class="form-control" placeholder="Enter Last Name" />
          </div>
             <div class="form-group">
            <label class="control-label">Date_Naiss_arabic_fr</label>
            <textarea maxlength="100" type="text" name="DateNaiss_arabic_fr" required="required" class="validate[required] form-control" /></textarea>
          </div>
          <div class="form-group">
            <label class="control-label">Date_Naiss_fr</label>
            <textarea maxlength="100" type="text" name="DateNaissE" required="required" class="validate[required] form-control" /></textarea>
          </div>
           <div class="form-group">
            <label class="control-label">LIEU DE NAISSANCE</label>
            <textarea maxlength="255" type="text" name="LieuNaissE" required="required" class="form-control" placeholder="Enter Company Name" /></textarea>
          </div>
           <div class="form-group">
            <label class="control-label">ADRESSE</label>
            <input  type="text" name="Adresse" required="required" class="form-control" placeholder="Enter Company Address"  />
          </div>
           <div class="form-group">
            <label class="control-label col-lg-4">SEXE</label>
                  <div class="checkbox">
                            <label>
                              <input class="uniform" type="radio" class="form-control" name="Sexe" required="required" value="Masculin" <?php echo set_radio('Sexe', '1', TRUE); ?> >Masculin
                            </label>
                            <label>
                              <input class="uniform" type="radio" class="form-control" name="Sexe" required="required" value="Féminin" <?php echo set_radio('Sexe', '2'); ?> >Féminin
                            </label>
                          </div>
                   </div>
                   <div class="form-group">
            <label class="control-label">Nationalité</label>
            <input maxlength="100" type="text" name="Nationalite_fr" required="required"  placeholder="Marocain" class=" validate[required]  form-control" placeholder="Enter Last Name" />
          </div><br>
    ...
    <div class="row setup-content" id="step-2">
        ...
        <div class="col-md-12">
            ...
            <input maxlength="100" type="text" name="Nom_ar" required="required"  class=" validate[required]  form-control" placeholder="Enter Last Name" />
          </div>
           <div class="form-group">
            <label class="control-label">الاسم</label>
            <input maxlength="100" type="text" name="Prenom_ar" required="required" class=" validate[required]  form-control" placeholder="Enter Last Name" />
          </div>
          <div class="form-group">
            <label class="control-label">تاريخ الازدياد العربي</label>
            <textarea maxlength="100" type="text" name="DateNaiss_arabic_ar" required="required" class="validate[required] form-control"  /></textarea>
          </div>
          <div class="form-group">
            <label class="control-label">تاريخ الازدياد الفرنسي</label>
            <textarea maxlength="100" type="text" name="DateNaiss_ar" required="required" class="validate[required] form-control"  /></textarea>
          </div>
          <div class="form-group">
            <label class="control-label">مكان الازدياد</label>
            <textarea maxlength="255" type="text" name="LieuNaiss_ar" required="required" class=" validate[required]  form-control" placeholder="Enter Company Name" /></textarea>
          </div>
          <div class="form-group">
            <label class="control-label">العنوان</label>
            <input  type="text" name="Adresse_ar" required="required" class="form-control" placeholder="Enter Company Address"  />
          </div>
           <div class="form-group">
            <label class="control-label col-lg-4">الجنس</label>
                  <div class="checkbox">
                   ...
                   <div class="form-group">
            <label class="control-label">جنسيته</label>
            <input maxlength="100" type="text" name="Nationalitr_ar" required="required"  placeholder="مغربية" class=" validate[required]  form-control" placeholder="Enter Last Name" />
          </div>
        ...
        <div class="col-md-12">
              <h3> Step 3</h3>
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-lg-8">
                          <select name="Cin_M" data-placeholder="Your Favorite Type of Bear"   class="form-control chzn-select-deselect" tabindex="7" placeholder="Le CIN des Parents" >
                          <option></option>
                            <?php if($allParent): ?>
                            <?php foreach($allParent as $parent): ?>
                            <option value="<?php echo $parent->Cin_M; ?>"  ><?php echo $parent->Cin_M ; ?></option>
                            <?php endforeach; ?>
                            <?php endif; ?>
                          </select>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                          <select  name="NumR" data-placeholder="Your Favorite Type of Bear"  class="form-control chzn-select-deselect" tabindex="7" placeholder="L'année d'un Registre" >
                          <option></option>
                          <?php if($AllRegistre): ?>
                          <?php foreach($AllRegistre as $registre): ?>
                            <option value="<?php echo $registre->NumR; ?>" ><?php echo $registre->Anne; ?></option>
                            <?php endforeach; ?>
                            <?php endif; ?>
                          </select>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                          <select data-placeholder="Your Favorite Type of Bear" name="Declaration_NumD" class="form-control chzn-select-deselect" tabindex="7" placeholder="Le Numéro du Déclaration" >
                          <option></option>
                          <?php if($allDeclar): ?>
