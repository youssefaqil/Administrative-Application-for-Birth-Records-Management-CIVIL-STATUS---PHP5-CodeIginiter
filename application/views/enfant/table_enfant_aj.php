              ...
              <div class="col-lg-12">
                <div class="box">
                  <header>
                   ...
                   <p class="text-success"><li class="col-sm-6 col-md-4 col-lg-3">
                    <i class="glyphicon glyphicon-plus"></i>&nbsp;<a href="<?php echo site_url('enfant_controller/form_ajou');?>">Ajouter les infos des enfants</a>
                  </li></p><br><br>
                  <div id="collapse4" class="body">
                  
               
                    <table align="center" id="dataTable" class="table table-bordered table-condensed table-hover table-striped">
                      <thead>
                        <tr>
                          ...
                          <th width="20px" align="center">Anné_Registre</th>
                          <th width="20px" align="center">Num_Déclaration</th>
                          <th width="20px" align="center">Imprimer Un Extrait</th>
                      ...
                      <?php if($allenfants): ?>
                       ...
                       <?php endforeach; ?>
                        <?php endif; ?>
                        <td width="10px" align="center"><?php echo $enfant->Declaration_NumD ; ?></td>
                             <!-- get anne registre selon IDEfant-->
                             <td width="20px" align="center"><li class="col-sm-6 col-md-4 col-lg-3"><i class="glyphicon glyphicon-align-left"></i>&nbsp;<a href="<?php echo site_url('doc/index/'.$enfant->idEnfant); ?>">Imrimer</a> </li></td>
