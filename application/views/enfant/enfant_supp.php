...
<style type="text/css">
 ...
 #table{width:530px;text-align: center;}
    ...
    <div class="bg-dark dk" id="wrap">
      <div id="top">
        ...
        <header class="head">
          ...
          <div class="main-bar">
            <h3>
              <i class="fa fa-square-o"></i>&nbsp; supprimer Page</h3>
          </div><!-- /.main-bar -->
        </header><!-- /.head -->
      </div><!-- /#top -->
      <div id="left">
            ...
            &nbsp;
             ...
             <div class="container">
                ...
                <div class="span10 offset1">
                  ...
                  <tr class="active"><td>Nom :</td><td><?php echo $enfant->NomE; ?></td></tr>
                  <tr class="warning"><td>Prenom :</td><td><?php echo $enfant->PrenomE; ?></td></tr>
                  <tr class="success"><td>Date_Naiss_arabic :</td><td><?php echo $enfant->DateNaiss_arabic_fr; ?></td></tr>
                  <tr class="info"><td>Date de naissance :</td><td><?php echo $enfant->DateNaissE; ?></td></tr>
                  <tr class="active"><td> Lieu de naissance:</td><td><?php echo $enfant->LieuNaissE; ?></td></tr>
                  <tr class="warning"><td>Adresse :</td><td><?php echo $enfant->Adresse; ?></td></tr>
                  <tr class="success"><td>Sexe :</td><td><?php echo $enfant->Sexe; ?></td></tr>
                  <tr class="info"><td>Nationalité:</td><td><?php echo $enfant->Nationalite_fr; ?></td></tr>
                   <tr class="active"><td>Cin_Parent :</td><td><?php echo $enfant->Parent_Cin_M; ?></td></tr>
                   <tr class="warning"><td>Num_Registre :</td><td><?php echo $enfant->Registre_NumR; ?></td></tr>
                   <tr class="success"><td>Num_Déclaration :</td><td><?php echo $enfant->Declaration_NumD; ?></td></tr>
                     <?php endforeach;?>
                     <?php endif; ?>
                     </table>
                ...
                <tr class="active"><td><?php echo $enfant->Nom_ar; ?></td><td> : النسب</td></tr>
                <tr class="warning"><td><?php echo $enfant->Prenom_ar; ?><td> : الاسم </td></td></tr>

                <tr class="success"><td><?php echo $enfant->DateNaiss_arabic_ar; ?></td><td> : تاريخ الازدياد العربي</td></tr>
                <tr class="info"><td><?php echo $enfant->DateNaiss_ar; ?><td> : تاريخ الازدياد </td></td></tr>
                <tr class="active"><td><?php echo $enfant->LieuNaiss_ar; ?><td> : مكان الازدياد </td></td></tr>
                <tr class="warning"><td><?php echo $enfant->Adresse_ar; ?></td><td> : العنوان </td></tr>
                <tr class="success"><td><?php echo $enfant->Sexe_ar; ?><td> : الجنس</td></td></tr>
                <tr class="info"><td><?php echo $enfant->Nationalitr_ar; ?></td><td> : الجنسية</td></tr>
                     <?php endforeach;?>
                     <?php endif; ?>
                     </table>
                    </div>
                    ...
                    <form class="form-horizontal" action="<?php echo site_url('enfant_controller/supp_enfant/'.$enfant->idEnfant); ?>" method="post">
                      <input type="hidden" name="id" value="<?php echo $enfant->idEnfant ?>"/>
                      <span class="label label-danger">vous avez sur que vous voulez supprimer cet enfant ?</span><br><br><br>
                      <div class="form-actions">
                          <button type="submit" class="btn btn-metis-1 btn-line" data-original-title="" title="">YES</button>

                          <a href="<?php echo site_url('enfant_controller/enfant_s'); ?>" class="btn btn-metis-2 btn-line" data-original-title="" title="">NON</a>
                        </div>
                    </form>
                </div>
