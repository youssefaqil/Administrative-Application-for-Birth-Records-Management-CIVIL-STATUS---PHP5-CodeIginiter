  ...
  <div class="bg-dark dk" id="wrap">
    ...
    <div class="row setup-content" id="step-1">
        ...
        <div class="col-md-12">
            ...
            <textarea maxlength="100" type="text" required="required" class="form-control" placeholder="Enter Last Name" /></textarea>
          </div>
   
              <button class="btn btn-primary nextBtn btn-lg btn-flat btn-rect pull-right" type="button" >Next</button>
            </div>
      </div>
        </div>
    ...
    <div class="row setup-content" id="step-3">
        ...
        <div class="col-md-12">
              ...
              <button class="btn btn-success btn-lg btn-flat btn-rect pull-right" type="submit">Submit</button>
            </div>
      </div>
        </div>
  </form>
