    ...
    <div class="bg-dark dk" id="wrap">
      <div id="top">
        ...
        <header class="head">
          ...
          <div class="main-bar">
            <h3>
              <i class="fa fa-table"></i>&nbsp; LES REGISTRES </h3>
          </div><!-- /.main-bar -->
        </header><!-- /.head -->
      </div><!-- /#top -->
      <div id="left">
              ...
              <div class="col-lg-12">
                <div class="box">
                  <header>
                    ...
                    <h5>Gestion d'un Registre</h5>
                  </header>
                  <div id="collapse4" class="body">
                 
                    <table id="dataTable" class="table table-bordered table-condensed table-hover table-striped">
                     <p><a href="<?php echo site_url('registre_controller/form_ajout');?>" class="btn btn-success">Ajouter Un REGISTRE</a></p>
                      <thead>
                        <tr>
                          <th>Anné Regsitre</th>
                          <th>Modifier</th>
                      ...
                      <tbody>
                        <tr>
                          <td><?php echo $registre->Anne; ?></td>
                          <td><a href="<?php echo site_url('registre_controller/form_modif/'.$registre->NumR); ?>" class="btn btn-info">Modifier Un REGISTRE</a></td>
                          <td><a href="<?php echo site_url('registre_controller/form_supprim/'.$registre->NumR); ?>" class="btn btn-danger">Supprimer Un REGISTRE</a></td>
                        </tr>
                      </tbody>
                      <?php endforeach; ?>
                      <?php endif ;?>
