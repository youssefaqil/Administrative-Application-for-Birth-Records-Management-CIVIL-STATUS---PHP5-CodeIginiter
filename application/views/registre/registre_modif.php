              ...
              <div class="col-lg-12">
                <div class="box">
                  ...
                  <?php if($registres): ?>
                    ...
                    <form class="form-horizontal" id="popup-validation" action="<?php echo site_url('registre_controller/modif_regist/$id')?>" method="post">
                      <div class="form-group">
                        <label class="control-label col-lg-4">Anne_REGISTRE</label>
                        <div class="col-lg-4">
                 <input type="text" class="validate[required,minSize[4],maxSize[4],custom[number]] form-control" name="Anne" id="req" value="<?php echo $registre->Anne; ?>">
                        </div>
                      </div>
