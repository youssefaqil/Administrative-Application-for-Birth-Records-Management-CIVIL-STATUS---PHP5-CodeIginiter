            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="box">
                  ...
                  <?php if($users): ?>
                    <?php foreach($users as $utilis): ?>
                    <form class="form-horizontal" id="popup-validation" action="<?php echo site_url('utilisa_controller/modif_user/'.$utilis->id_user)?>" method="post">
                      <div class="form-group">
                        <label class="control-label col-lg-4">Pseudo:</label>
                        <div class="col-lg-4">
                 <input type="text" class="validate[required] form-control" name="pseudo" id="req" value="<?php echo $utilis->pseudo; ?>">
                        </div>
                      </div>
                       <div class="form-group">
                        <label class="control-label col-lg-4">Mot De Passe:</label>
                        <div class="col-lg-4">
                 <input type="text" class="validate[required] form-control" name="password" id="req" value="<?php echo $utilis->password; ?>">
                        </div>
                      </div>
                       <div class="form-group">
                        <label class="control-label col-lg-4">Role:</label>
                        <div class="col-lg-4">
                 <input type="text" class="validate[required] form-control" name="user_type" id="req" value="<?php echo $utilis->user_type; ?>">
                        </div>
                      </div>
