              ...
              <div class="col-lg-12">
                <div class="box">
                  ...
                  <div id="collapse2" class="body">
                    ...
                    <form class="form-horizontal" id="popup-validation" action="<?php echo site_url('utilisa_controller/ajout_utilis'); ?>" method="post">
                      <div class="form-group">
                        <label class="control-label col-lg-4">Pseudo</label>
                        <div class="col-lg-4">
                          <input type="text" class="validate[required] form-control" name="pseudo" id="req"><p><?php echo form_error('pseudo'); ?></p>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-lg-4">
                          <input type="password" class="validate[required] form-control"  name="password" id="req"><p><?php echo form_error('password'); ?></p>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-lg-4">
                          <input type="text" class="validate[required] form-control"  name="user_type" id="req"><p><?php echo form_error('user_type'); ?></p>
