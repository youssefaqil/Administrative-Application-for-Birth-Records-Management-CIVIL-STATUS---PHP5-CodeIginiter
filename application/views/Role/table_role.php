    ...
    <div class="bg-dark dk" id="wrap">
      <div id="top">
        ...
        <header class="head">
          ...
          <div class="main-bar">
            <h3>
              <i class="fa fa-table"></i>&nbsp; Les Roles </h3>
          </div><!-- /.main-bar -->
        </header><!-- /.head -->
      </div><!-- /#top -->
      <div id="left">
              ...
              <div class="col-lg-12">
                <div class="box">
                  <header>
                    ...
                    <h5>Gestion d'un role</h5>
                  </header>
                  <div id="collapse4" class="body">
                 
                    <table id="dataTable" class="table table-bordered table-condensed table-hover table-striped">
                     <p><a href="<?php echo site_url('role_controller/form_ajout');?>" class="btn btn-success">Ajouter Un Utilisateur</a></p>
                      <thead>
                        <tr>
                          <th>Utilisateur</th>
                          <th>Role</th>
                      ...
                      <tbody>
                        <tr>
                         ...
                         <?php endif ;?>
                          ...
                          <td><a href="<?php echo site_url('role_controller/form_modif/'.$role->Id_role); ?>" class="btn btn-info">Modifier Un Utilisateur</a></td>
                          <td><a href="<?php echo site_url('role_controller/form_supprim/'.$role->Id_role); ?>" class="btn btn-danger">Supprimer Un Utilisateur</a></td>
                        </tr>
                      </tbody>
                      <?php endforeach; ?>
                      <?php endif ;?>
