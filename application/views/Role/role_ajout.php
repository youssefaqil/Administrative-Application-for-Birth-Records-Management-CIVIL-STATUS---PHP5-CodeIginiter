              ...
              <div class="col-lg-12">
                <div class="box">
                  <header class="dark">
                    ...
                    <h5>Ajouter l'anné d'un  Registre</h5>
                  ...
                  <div id="collapse2" class="body">
                    ...
                    <form class="form-horizontal" id="popup-validation" action="<?php echo site_url('role_controller/Ajout_role'); ?>" method="post">
                ...
                <div class="form-group">
                        ...
                        <div class="col-lg-8">
                          <select name="id_perm" data-placeholder="Your Favorite Type of Bear" class="form-control chzn-select-deselect" tabindex="7">
                          <option></option>
                            <?php if($privilege): ?>
                      ...
                      <div class="form-actions no-margin-bottom">
                        <input type="submit" value="Enregistrer" class="btn btn-success" name="save">
                      </div>
                    </form>
                  </div>
                </div>
