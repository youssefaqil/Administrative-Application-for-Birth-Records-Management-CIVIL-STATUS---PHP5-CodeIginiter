    ...
    <div class="bg-dark dk" id="wrap">
      <div id="top">
        ...
        <header class="head">
          ...
          <div class="main-bar">
            <h3>
              <i class="fa fa-filter"></i>&nbsp; Form REGISTRE</h3>
          </div><!-- /.main-bar -->
        </header><!-- /.head -->
      </div><!-- /#top -->
      <div id="left">
              ...
              <div class="col-lg-12">
                <div class="box">
                  <header class="dark">
                    ...
                    <h5>Modifier l'anné d'un  Registre</h5>
                  ...
                  <?php if($roles): ?>
                    ...
                    <form class="form-horizontal" id="popup-validation" action="<?php echo site_url('role_controller/modif_role/'.$role->Id_role)?>" method="post">
                       
                      <div class="form-group">
                        <label class="control-label col-lg-4">Utilisateur: </label>
                        <div class="col-lg-8">
                       <select data-placeholder="Your Favorite Type of Bear" name="id_user" class="form-control chzn-select-deselect" tabindex="7">

                          <?php if($users): ?>
                            <?php foreach($users as $user): ?>
                              <?php if($user->id_user == $role->users_id_user ):?>
                              
                              <option value="<?php echo $role->users_id_user; ?>">
                              ...
                              <?php endforeach;?>
                          <?php foreach($users as $user): ?>
                            <option value="<?php echo $user->id_user; ?>"><?php echo $user->pseudo; ?></option>
                            <?php endforeach; ?>
                            <?php endif; ?>
                          </select>
                          </div>
                         ...
                         <div class="form-group">
                        <label class="control-label col-lg-4">Privilége : </label>
                        <div class="col-lg-8">
                       <select data-placeholder="Your Favorite Type of Bear" name="id_perm" class="form-control chzn-select-deselect" tabindex="7">

                          <?php if($privilege): ?>
                            <?php foreach($privilege as $privil): ?>
                              <?php if($privil->id_perm == $role->permission_id_perm ):?>
                              
                              <option value="<?php echo $role->permission_id_perm; ?>">
                                <!-- afficher Anne selon idEnfant pour le modifier -->
                              <?php echo $privil->privilege; ?>
                              </option>
                              <?php endif; ?>
                              <?php endforeach;?>
                         <?php foreach($privilege as $privil): ?>
                            <option value="<?php echo $privil->id_perm; ?>"><?php echo $privil->privilege; ?></option>
                            <?php endforeach; ?>
                            <?php endif; ?>
                          </select>
                      </div>
