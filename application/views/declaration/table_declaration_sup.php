    ...
    <div class="bg-dark dk" id="wrap">
      <div id="top">
        ...
        <header class="head">
          ...
          <div class="main-bar">
            <h3>
              <i class="fa fa-table"></i>&nbsp; Table parent </h3>
          </div><!-- /.main-bar -->
        </header><!-- /.head -->
      </div><!-- /#top -->
      <div id="left">
                  ...
                  <div id="collapse4" class="body">
                    ...
                    <table id="dataTable" class="table table-bordered table-condensed table-hover table-striped">
                      ...
                      <?php if($declarations): ?>
                        ...
                        <tr>
                          <td width="10px"><?php echo $declaration->NumD ; ?></td>
                          <td width="10px"><?php echo $declaration->AnneD ; ?></td>
                          <?php if($registres): ?>
                          <?php foreach($registres as $registre): ?>
                          <?php if(( $registre->NumR)==($declaration->Registre_NumR)): ?>
                          <td width="10px"><?php echo $registre->Anne ; ?></td>
                          <?php endif; ?>
                           <?php endforeach; ?>
                          <?php endif; ?>
                          <td width="10px"><?php echo $declaration->Parent_Cin_M ; ?></td>
                       <td width="10px"><li class="col-sm-6 col-md-4 col-lg-3" ><i class="glyphicon glyphicon-trash"></i>&nbsp;<a href="<?php echo site_url('declaration_controller/form_supp/'.$declaration->NumD);?>" class="text-danger">Supprimer</a> </li></td>
                        </tr>
                        <?php endforeach; ?>
                        <?php endif; ?>
                      </tbody>
