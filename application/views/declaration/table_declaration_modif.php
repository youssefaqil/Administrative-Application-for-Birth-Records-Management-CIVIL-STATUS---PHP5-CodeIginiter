                ...
                <div class="box">
                  ...
                  <div id="collapse4" class="body">
                    ...
                    <table id="dataTable" class="table table-bordered table-condensed table-hover table-striped">
                      ...
                      <td width="10px"><li class="col-sm-6 col-md-4 col-lg-3"><i class="glyphicon glyphicon-pencil"></i>&nbsp;<a href="<?php echo site_url('declaration_controller/form_modif/'.$declaration->NumD);?>">Modifier</a> </li></td>
                        </tr>
                        <?php endforeach; ?>
                        <?php endif; ?>
                      </tbody>
