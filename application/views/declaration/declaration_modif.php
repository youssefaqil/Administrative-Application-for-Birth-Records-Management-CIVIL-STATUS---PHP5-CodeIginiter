                ...
                <div class="box">
                  ...
                  <?php if($declarations): ?>
                    <?php foreach($declarations as $declaration): ?>
                      <div id="position">
                    <form class="form-horizontal" id="popup-validation" action="<?php echo site_url('declaration_controller/modifier_dec/'.$declaration->NumD); ?>" method="post">
                  
                     <div class="form-group">
                        <label class="control-label col-lg-4">Date Declaration</label>
                        <div class="col-lg-4">
                          <input type="date" id="date3" name="AnneD" class="validate[required,custom[date]] form-control" value="<?php echo $declaration->AnneD;  ?>">
                        </div>
                        </div>
                         <div class="form-group">
                        <label class="control-label col-lg-4">Anné Registre</label>
                        <div class="col-lg-4">
                          <select name="Registre_NumR" id="sport" class="validate[required] form-control">
                          <?php if($registres): ?>
                          <?php foreach($registres as $registre): ?>
                          <?php if(($registre->NumR)==($declaration->Registre_NumR)): ?>
                            <option value="<?php echo $declaration->Registre_NumR;  ?>"><?php echo $registre->Anne; ?></option>
                            <?php endif; ?>
                            <?php endforeach; ?>
                            <?php foreach($registres as $registre): ?>
                          ...
                          <div class="form-group">
                        <label class="control-label col-lg-4">Cin Parent</label>
                        <div class="col-lg-4">
                          <select name="Parent_Cin_M" id="sport" class="validate[required] form-control">
                            <option value="<?php echo $declaration->Parent_Cin_M; ?>"><?php echo $declaration->Parent_Cin_M; ?></option>
                            <?php if($parents): ?>
