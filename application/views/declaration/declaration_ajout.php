              ...
              <div class="col-lg-12">
                <div class="box">
                  ...
                  <div id="collapse2" class="body">
                    <form class="form-horizontal" id="popup-validation" action="<?php  echo site_url('declaration_controller/declaration_aj'); ?>" method="post">
                      <div class="form-group">
                        <label class="control-label col-lg-4">Date Declaration</label>
                        <div class="col-lg-4">
                          <input type="date" id="date3" name="AnneD" class="validate[required,custom[date]] form-control">
                        </div>
                        </div>
                         <div class="form-group">
