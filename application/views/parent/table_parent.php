...
<html class="no-js">
  <head>
    <meta charset="UTF-8">
    <title>listes des Parents</title>
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="box">
                  ...
                  <p><a href="<?php echo site_url('parent_controller/Ajout_parent');?>" class="btn btn-success">Ajouter les infos des parents</a></p>
                    <table id="dataTable" class="table table-bordered table-condensed table-hover table-striped">
                      ...
                      <?php if($allparents): ?>
                        ...
                        <tr>
                          <td width="10px"><?php echo $parent->Cin_M ; ?></td>
                          <td width="10px"><?php echo $parent->NomP ; ?></td>
                          <td width="10px"><?php echo $parent->Nom_ar ; ?></td>
                          <td width="10px"><?php echo $parent->PrenomP ; ?></td>
                          <td width="10px"><?php echo $parent->Prenom_ar ; ?></td>
                          
                          <td width="10px"><li class="col-sm-6 col-md-4 col-lg-3"><i class="glyphicon glyphicon-pencil"></i>&nbsp;<a href="<?php echo site_url('parent_controller/form_modif/'.$parent->Cin_M); ?>">Modifier</a> </li></td>
                         
                          <td width="10px"><li class="col-sm-6 col-md-4 col-lg-3" ><i class="glyphicon glyphicon-trash"></i>&nbsp;<a href="<?php echo site_url('parent_controller/form_supp/'.$parent->Cin_M);?>" class="text-danger">Supprimer</a> </li></td>
                        </tr>
                        <?php endforeach; ?>
                        <?php endif; ?>
                      </tbody>
