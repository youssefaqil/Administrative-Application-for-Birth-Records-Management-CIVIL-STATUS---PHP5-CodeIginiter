    ...
    <div class="bg-dark dk" id="wrap">
      <div id="top">
        ...
        <header class="head">
          ...
          <div class="main-bar">
            <h3>
              <i class="fa fa-filter"></i>&nbsp; Form PARENT</h3>
          </div><!-- /.main-bar -->
        </header><!-- /.head -->
      </div><!-- /#top -->
      <div id="left">
              ...
              <div class="col-lg-12">
                <div class="box">
                  <header class="dark">
                    ...
                    <h5>Modifier les infomation de ce parent </h5>
                  ...
                  <?php if($parents): ?>
                    <?php foreach($parents as $parent): ?>
                      <div id="position">
                    <form class="form-horizontal" id="popup-validation" action="<?php echo site_url('parent_controller/modif_regist/'.$parent->Cin_M); ?>" method="post">
                  
                      <div class="form-group">
                        <label class="control-label col-lg-4">NOM :</label>
                        <div class="col-lg-4">
                          <input type="text" name="NomP" class="validate[required] form-control" name="NomP" id="req"  value="<?php echo $parent->NomP; ?>">
                         </div>
                         </div>
                         <div class="form-group">
                        <label class="control-label col-lg-4"> النسب :</label>
                        <div class="col-lg-4">
                          <input type="text" name="Nom_ar" class="validate[required] form-control" name="Nom_ar" id="req"  value="<?php echo $parent->Nom_ar; ?>">
                         </div>
                      </div>
                        <div class="form-group">
                        <label class="control-label col-lg-4">PRENOM : </label>
                        <div class="col-lg-4">
                          <input type="text" name="PrenomP" class="validate[required] form-control" name="PrenomP" id="req"  value="<?php echo $parent->PrenomP; ?>">
                         </div>
                         </div>
                          <div class="form-group">
                        <label class="control-label col-lg-4">الاسم : </label>
                        <div class="col-lg-4">
                          <input type="text" name="Prenom_ar" class="validate[required] form-control" name="Prenom_ar" id="req"  value="<?php echo $parent->Prenom_ar; ?>">
                         </div>
                      </div>
                        <div class="form-group">
                        <label class="control-label col-lg-4">DTE NAISSANCE : </label>
                        <div class="col-lg-4">
                          <input type="text" name="DateNaissP" class="validate[required] form-control" name="DateNaissP" id="req"  value="<?php echo $parent->DateNaissP; ?>">
                        </div>
                        </div>
                         <div class="form-group">
                        <label class="control-label col-lg-4">تاريخ الازدياد : </label>
                        <div class="col-lg-4">
                          <input type="text" name="Date_ar" class="validate[required] form-control" name="Date_ar" id="req"  value="<?php echo $parent->Date_ar; ?>">
                         </div>
                      </div>
                        <div class="form-group">
                        <label class="control-label col-lg-4">LIEU NAISSANCE : </label>
                        <div class="col-lg-4">
                          <input type="text" name="LieuNaissP" class="validate[required] form-control" name="LieuNaissP" id="req"  value="<?php echo $parent->LieuNaissP; ?>">
                         </div>
                         </div>
                          <div class="form-group">
                        <label class="control-label col-lg-4">مكان الازدياد </label>
                        <div class="col-lg-4">
                          <input type="text" name="LieuNaissP_ar" class="validate[required] form-control" name="LieuNaissP_ar" id="req"  value="<?php echo $parent->LieuNaissP_ar; ?>">
                         </div>
                      </div>
                        <div class="form-group">
                        <label class="control-label col-lg-4">ADRESSE : </label>
                        <div class="col-lg-4">
                          <input type="text" name="AdresseP" class="validate[required] form-control" name="AdresseP" id="req"  value="<?php echo $parent->AdresseP; ?>">
                         </div>
                         </div>
                         <div class="form-group">
                        <label class="control-label col-lg-4">العنوان : </label>
                        <div class="col-lg-4">
                          <input type="text" name="AdressP_ar" class="validate[required] form-control" name="AdressP_ar" id="req"  value="<?php echo $parent->AdressP_ar; ?>">
                         </div>
                      </div>
                        <div class="form-group">
                        <label class="control-label col-lg-4">PROFESSION : </label>
                        <div class="col-lg-4">
                          <input type="text" name="Profession" class="validate[required] form-control" name="Profession" id="req"  value="<?php echo $parent->Profession; ?>">
                         </div>
                         </div>
                         <div class="form-group">
                        <label class="control-label col-lg-4">المهنة: </label>
                        <div class="col-lg-4">
                          <input type="text" name="Profession_ar" class="validate[required] form-control" name="Profession_ar" id="req"  value="<?php echo $parent->Profession_ar; ?>">
                         </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="checkbox">
                            <label>
                              <input class="uniform" type="radio" class="form-control" name="Sexe" required="required" value="H" <?php echo set_value('Sexe', $parent->Sexe) == 'H' ? "checked" : ""; ?> />H
                            </label>
                            <label>
                              <input class="uniform" type="radio" class="form-control" name="Sexe" required="required" value="F"<?php echo set_value('Sexe', $parent->Sexe) == 'F' ? "checked" : ""; ?> >F
                            </label>
                          </div>
                      </div>
                       <div class="form-group">
                      ...
                      <div class="checkbox">
                            <label>
                              <input class="uniform" type="radio" class="form-control" name="Sexe_ar" required="required" value="ذكر" <?php echo set_value('Sexe_ar', $parent->Sexe_ar) == 'ذكر' ? "checked" : ""; ?> />ذكر
                            </label>
                            <label>
                              <input class="uniform" type="radio" class="form-control" name="Sexe_ar" required="required" value="انثى"<?php echo set_value('Sexe_ar', $parent->Sexe_ar) == 'انثى' ? "checked" : ""; ?>/>انثى
                            </label>
                          </div>
                      </div>
                        <div class="form-actions no-margin-bottom">
                        <input type="submit" value="Modifier" class="btn btn-info" name="update">
                      </div>
                    </form>
                    </div>
                    <?php endforeach; ?>
