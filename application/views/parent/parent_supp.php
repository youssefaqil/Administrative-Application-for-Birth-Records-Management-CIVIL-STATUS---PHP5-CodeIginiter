            ...
            &nbsp;
             ...
             <div class="container">
                ...
                <div class="span10 offset1">
                  ...
                  <tr class="active"><td>Nom :</td><td><?php echo $parent->NomP; ?></td></tr>
                  <tr class="active"><td>النسب :</td><td><?php echo $parent->Nom_ar; ?></td></tr>
                  <tr class="success"><td>Prenom :</td><td><?php echo $parent->PrenomP; ?></td></tr>
                  <tr class="success"><td>الاسم :</td><td><?php echo $parent->Prenom_ar; ?></td></tr>
                  <tr class="warning"><td>Date de naissance :</td><td><?php echo $parent->DateNaissP; ?></td></tr>
                  <tr class="info"><td>تاريخ الازدياد :</td><td><?php echo $parent->Date_ar; ?></td></tr>
                  <tr class="info"><td> Lieu de naissance:</td><td><?php echo $parent->LieuNaissP; ?></td></tr>
                  <tr class="info"><td> مكان الازدياد :</td><td><?php echo $parent->LieuNaissP_ar; ?></td></tr>
                  <tr class="active"><td>Adresse :</td><td><?php echo $parent->AdresseP; ?></td></tr>
                  <tr class="active"><td>العنوان :</td><td><?php echo $parent->AdressP_ar; ?></td></tr>
                  <tr class="success"><td>Profession :</td><td><?php echo $parent->Profession; ?></td></tr>
                  <tr class="success"><td>المهنة:</td><td><?php echo $parent->Profession_ar; ?></td></tr>
                  <tr class="warning"><td>Sexe :</td><td><?php echo $parent->Sexe; ?></td></tr>
                  <tr class="warning"><td>الجنس :</td><td><?php echo $parent->Sexe_ar; ?></td></tr>
                     <?php endforeach;?>
                     <?php endif; ?>
                     </table>
                    </div>
                    ...
                    <form class="form-horizontal" action="<?php echo site_url('parent_controller/supp_parent/'.$parent->Cin_M); ?>" method="post">
                      <input type="hidden" name="id" value="<?php echo $parent->Cin_M ?>"/>
                      <span class="label label-danger">vous avez sur que vous voulez supprimer ce parent ?</span><br><br><br>
                      <div class="form-actions">
                          <button type="submit" class="btn btn-metis-1 btn-line" data-original-title="" title="">YES</button>

                          <a href="<?php echo site_url('parent_controller/parent_s'); ?>" class="btn btn-metis-2 btn-line" data-original-title="" title="">NON</a>
                        </div>
                    </form>
                </div>
